...
if plr.Name == "CreoAgainAgain" or plr.Name == "ItsNotFair_1" then
chat("The Creator of Butterloaf has joined the game")
end
end)
...
game.Players.PlayerAdded:Connect(function(plr)
if plr.Name == "CreoAgainAgain" or plr.Name == "ItsNotFair_1" then
chat("The Creator of Butterloaf has joined the game: "..plr.Name)
end
end)
...
Msgreq("FE Butterloaf V2 by Creo","Loading, please wait while it loads",5,nil)
...
bambam.Force = Vector3.new(500,500,500)
...
if AudioReplication == true then -- sin cause tan, get it?
	...
	spawn(function()
		...
		s = game:GetService("RunService").Heartbeat:connect(function()
			ReplicationBoombox.Handle.Velocity = Vector3.new(0,50,0)
		end)
		spawn(function()
			while true do
				wait()
...
s = game:GetService("RunService").Heartbeat:connect(function()
	...
	while true do
		...
		if HumanDied == true then
			s:Disconnect()
Msgreq("FE Butterloaf V2 by Creo","Butterloaf Killed, rejoining",5,nil)
...
chat("[The butterloaf experience loaded] included in Creo Scripts Premium")
